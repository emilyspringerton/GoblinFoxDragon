...
**Status:** Milestones 1-2 shipped 2026-07-31 (Warrior's real weapon skills wired into
`arena_game.c`'s Q/W/R slots, then real skillchain resonance detection between them) — milestones
3-5 still ahead.

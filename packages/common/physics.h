...
static const Box map_geo_city_base[] = {
    ...
    {180.0f, 8.0f, 132.0f, 36.0f, 16.0f, 30.0f},
    {180.0f, 8.0f, 220.0f, 36.0f, 16.0f, 30.0f},
    {132.0f, 8.0f, 176.0f, 30.0f, 16.0f, 36.0f},
    {228.0f, 8.0f, 176.0f, 30.0f, 16.0f, 36.0f},

    // Grand Avenue institutions
    {138.0f, 9.0f, 258.0f, 44.0f, 18.0f, 34.0f},
    {222.0f, 10.0f, 258.0f, 46.0f, 20.0f, 36.0f},
    {138.0f, 10.0f, 338.0f, 40.0f, 20.0f, 34.0f},
    {222.0f, 9.0f, 338.0f, 42.0f, 18.0f, 34.0f},

    // Brush blocks neighborhood (northwest)
    {24.0f, 8.0f, 292.0f, 44.0f, 16.0f, 34.0f},
    {86.0f, 8.0f, 292.0f, 44.0f, 16.0f, 34.0f},
    {24.0f, 8.0f, 356.0f, 44.0f, 16.0f, 34.0f},
    {86.0f, 8.0f, 356.0f, 44.0f, 16.0f, 34.0f},
    {24.0f, 8.0f, 420.0f, 44.0f, 16.0f, 34.0f},
    {86.0f, 8.0f, 420.0f, 44.0f, 16.0f, 34.0f},

    // Stadium district (north-east) as town district, not abstract platforms
    {270.0f, 7.0f, 390.0f, 180.0f, 14.0f, 140.0f},
    {270.0f, 14.0f, 390.0f, 120.0f, 12.0f, 86.0f},
    {342.0f, 9.0f, 420.0f, 56.0f, 18.0f, 56.0f},
    {200.0f, 9.0f, 420.0f, 56.0f, 18.0f, 56.0f},

    // Warehouse/harbor edge (west)
    {-112.0f, 8.0f, 156.0f, 96.0f, 16.0f, 62.0f},
    {-112.0f, 8.0f, 232.0f, 96.0f, 16.0f, 62.0f},
    {-46.0f, 7.0f, 194.0f, 34.0f, 14.0f, 116.0f},

    // Financial edge (east)
    {334.0f, 20.0f, 62.0f, 70.0f, 40.0f, 52.0f},
    {430.0f, 24.0f, 42.0f, 64.0f, 48.0f, 64.0f},
    ...
    {304.0f, 8.0f, 548.0f, 56.0f, 16.0f, 44.0f},

    // Route shaping walls for block readability (no platform test fragments)
    {118.0f, 4.0f, 180.0f, 6.0f, 8.0f, 820.0f},
    {242.0f, 4.0f, 180.0f, 6.0f, 8.0f, 820.0f},
    {-6.0f, 4.0f, 300.0f, 212.0f, 8.0f, 6.0f},
    {-6.0f, 4.0f, 424.0f, 212.0f, 8.0f, 6.0f},
    {366.0f, 4.0f, 300.0f, 216.0f, 8.0f, 6.0f},
    {366.0f, 4.0f, 424.0f, 216.0f, 8.0f, 6.0f}
};


static const Box map_geo_mines[] = {
    {0.0f, -2.0f, 40.0f, 360.0f, 4.0f, 420.0f},

    {0.0f, 9.0f, 40.0f, 360.0f, 2.0f, 420.0f},
    {0.0f, 9.0f, -20.0f, 88.0f, 1.5f, 3.0f},
    {0.0f, 9.0f, 44.0f, 70.0f, 1.5f, 3.0f},
    {0.0f, 9.0f, 98.0f, 58.0f, 1.5f, 3.0f},
    {-88.0f, 9.0f, 118.0f, 54.0f, 1.5f, 3.0f},
    {86.0f, 10.0f, 126.0f, 44.0f, 1.5f, 3.0f},
    {0.0f, 9.0f, 158.0f, 42.0f, 1.5f, 3.0f},

    {0.0f, 5.0f, -94.0f, 42.0f, 10.0f, 2.5f},
    {0.0f, 5.0f, -50.0f, 42.0f, 10.0f, 2.5f},
    {-22.0f, 5.0f, -72.0f, 2.5f, 10.0f, 42.0f},
    {22.0f, 5.0f, -72.0f, 2.5f, 10.0f, 42.0f},

    {0.0f, 5.0f, 44.0f, 72.0f, 10.0f, 2.5f},
    {-36.0f, 5.0f, 16.0f, 2.5f, 10.0f, 58.0f},
    {36.0f, 5.0f, 16.0f, 2.5f, 10.0f, 58.0f},

    {-40.0f, 5.0f, 62.0f, 2.5f, 10.0f, 42.0f},
    {-84.0f, 5.0f, 82.0f, 90.0f, 10.0f, 2.5f},
    {-128.0f, 5.0f, 118.0f, 2.5f, 10.0f, 74.0f},
    {-86.0f, 5.0f, 154.0f, 86.0f, 10.0f, 2.5f},
    {-44.0f, 5.0f, 118.0f, 2.5f, 10.0f, 74.0f},

    {40.0f, 5.0f, 64.0f, 2.5f, 10.0f, 46.0f},
    {82.0f, 5.0f, 88.0f, 86.0f, 10.0f, 2.5f},
    {124.0f, 5.0f, 128.0f, 2.5f, 12.0f, 82.0f},
    {86.0f, 5.0f, 168.0f, 78.0f, 12.0f, 2.5f},
    {48.0f, 5.0f, 128.0f, 2.5f, 12.0f, 82.0f},

    {0.0f, 5.0f, 98.0f, 36.0f, 10.0f, 2.5f},
    {-18.0f, 5.0f, 138.0f, 2.5f, 10.0f, 42.0f},
    {18.0f, 5.0f, 138.0f, 2.5f, 10.0f, 42.0f},
    {0.0f, 5.0f, 178.0f, 36.0f, 10.0f, 2.5f},

    {-4.0f, 2.5f, -72.0f, 4.0f, 5.0f, 4.0f},
    {6.0f, 2.5f, -62.0f, 4.0f, 5.0f, 4.0f},
    {-12.0f, 2.0f, 18.0f, 3.0f, 4.0f, 3.0f},
    {14.0f, 2.0f, 26.0f, 3.0f, 4.0f, 3.0f},
    {-72.0f, 2.0f, 98.0f, 4.5f, 4.0f, 4.5f},
    {-108.0f, 2.0f, 140.0f, 4.5f, 4.0f, 4.5f},
    {74.0f, 2.0f, 106.0f, 4.5f, 4.0f, 4.5f},

...
typedef enum {
    TOWN_BLD_TAG_ENTERABLE = 1 << 0,
    TOWN_BLD_TAG_DISTRICT_CIVIC = 1 << 1,
    TOWN_BLD_TAG_DISTRICT_MARKET = 1 << 2,
    TOWN_BLD_TAG_DISTRICT_BRUSH = 1 << 3,
    TOWN_BLD_TAG_DISTRICT_STADIUM = 1 << 4,
    TOWN_BLD_TAG_DISTRICT_WAREHOUSE = 1 << 5,
    TOWN_BLD_TAG_DISTRICT_FINANCIAL = 1 << 6
} TownBuildingTagFlags;

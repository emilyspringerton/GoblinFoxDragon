...
// above in main.go. Returns ok=false for an item_id that no longer resolves (a removed/renamed
// item since it was persisted) -- a real, honest degrade, not equipping a broken, defID-less
// entry.
